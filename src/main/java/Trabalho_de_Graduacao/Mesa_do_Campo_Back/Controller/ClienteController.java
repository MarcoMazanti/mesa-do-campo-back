...
public class ClienteController {
    ...
    @GetMapping("/auto")
    public ResponseEntity<ClienteDTO> getCliente(@RequestParam("idUsuarioAuth") int idUsuarioAuth) {
    ...
    public ResponseEntity<ClienteDTO> updateSenha(@RequestBody Map<String, String> body, @RequestParam("idUsuarioAuth") int idUsuarioAuth) {
    ...
    public ResponseEntity<ClienteDTO> updateEndereco(@PathVariable("idEndereco") int idEndereco, @RequestParam("idUsuarioAuth") int idUsuarioAuth) {
