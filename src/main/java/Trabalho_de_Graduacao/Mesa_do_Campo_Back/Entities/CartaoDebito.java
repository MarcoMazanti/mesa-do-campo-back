...
@Schema(description = "Cartão de débito salvo por um cliente. Não guarda o número completo — só os últimos dígitos e um token de gateway.")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Entity(name = "cartao_debito")
public class CartaoDebito {
    @Schema(description = "Identificador único do cartão, gerado pelo banco.", example = "6", accessMode = Schema.AccessMode.READ_ONLY)
    @Id
    ...
    @Schema(description = "Apelido do cartão, definido pelo próprio cliente.", example = "Débito Banco X")
    @NotNull
    ...
    @Schema(description = "Últimos 4 dígitos do cartão (nunca o número completo).", example = "7788")
    @NotNull
    ...
    public CartaoDebito(int idCliente, String nome, String bandeira, int ultimosDigitos, String tokenGateway, boolean isPadrao) {
    ...
    public CartaoDebito(int idCliente, String nome, String bandeira, int ultimosDigitos, String tokenGateway) {
        this.idCliente = idCliente;
        this.nome = nome;
        this.bandeira = bandeira;
        this.ultimosDigitos = ultimosDigitos;
